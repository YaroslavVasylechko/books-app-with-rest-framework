...
class BooksApiTestCase(APITestCase):
    def setUp(self):
        ...
        self.book_3 = Book.objects.create(name='Test book 3 Author 1', price=30, author_name='Author 3',
                                          owner=self.user)

    def test_get(self):
        url = reverse('book-list')  # 'book-detail' to one book
    ...
    def test_get_ordering(self):
        url = reverse('book-list')
        response = self.client.get(url, data={'price': 30})
...
class BooksRelationsTestCase(APITestCase):
    ...
    def test_like(self):
        url = reverse('userbookrelation-detail', args=(self.book_1.id,))  # 'book-detail' to one book
        data = {
            "like": True,
        }
        json_data = json.dumps(data)
